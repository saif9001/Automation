...
public class ExcelUtil {
	...
	public static String testDataExcelPath="/Users/kiwitech/Documents/GitHub/Automation/src/main/java/excelutils/TestData.xlsx";
    ...
    public static String [][] userdata=new String[2][2];
	...
	public static String[][] setExcelFile(String Path,String SheetName,String testdatatopick) throws Exception {
	...
	public static void main(String[] args) throws Exception{
		...
		ExcelUtil.setExcelFile(ExcelUtil.testDataExcelPath,"sheet1","Invalid Credential");
